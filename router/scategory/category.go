...
func (s *CategoryRouter) InitCategoryRouter(Router *gin.RouterGroup) {
	...
	var categoryApi = v1.ApiGroupApp.ScategoryApiGroup.CategoryApi
	{
	...
	}
	{
		...
		categoryRouterWithoutRecord.GET("getCategoryListAll", categoryApi.GetCategoryListAll)  // 获取Category所有列表
	}
}
